                        ...
                        <div className="branch-block col-lg-4 col-md-12 col-sm-12">
                            <div className="inner-box">
                                ...
                                <ul className="info-list">
                                    <li><i className="fa fa-phone"></i> <Link to="tel:666888000">666 888 000</Link><br /></li>
                                    <li><i className="fa fa-envelope"></i> <Link to="mailto:needhelp@company.com">needhelp@company.com</Link><br /></li>
