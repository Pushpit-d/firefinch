    ...
    return (
        <>
            ...
            <HeroPageTitle
                ...
                breadcrumb={[
                    { link: '/', title: 'Home' },
                    { link: '/it-infra-network-solutions', title: 'IT Infrastructure & Network Solutions' },
                ]}
            />
            <section className="it-infra-network-solutions">
                    ...
                    <div className="row">
                                    ...
                                    <div className="service-sidebar wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1200m">
                                        <div className="service-list">
                                            ...
                                            <li>
                                                ...
                                                <li>
                                                    <Link to="/it-infra-network-solutions" className="current">
                                                        <i className="fas fa-angle-right"></i>
                        ...
                        <div className="col-xl-8 col-lg-8">
                            <div className="services-details__content">
                                ...
                                <h2 className="mt-4">Our Infrastructure Expertise</h2>
                                <p>We plan, deploy, and maintain secure IT environments that support your day-to-day operations — from internal networks to cloud-ready setups.</p>
                                
                                <div className="content mt-40">
                                    <div className="text">
                                        <h3>What You Get with Our Infrastructure Solutions</h3>
                                        <p>Our team ensures your business has the technical foundation to operate smoothly, scale efficiently, and stay secure.</p>
                                    </div>
                                        ...
                                        <div className="row clearfix">
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    ...
                                                    <h6 className="title">Structured cabling, routers, and firewall setup</h6>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    <div className="icon-box"><i className="fas fa-check-circle"></i></div>
                                                    <h6 className="title">Enterprise server configuration and monitoring</h6>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    <div className="icon-box"><i className="fas fa-check-circle"></i></div>
                                                    <h6 className="title">VPN and remote access solutions</h6>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    <div className="icon-box"><i className="fas fa-check-circle"></i></div>
                                                    <h6 className="title">Hardware procurement and system integration</h6>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    <div className="icon-box"><i className="fas fa-check-circle"></i></div>
                                                    <h6 className="title">24/7 infrastructure support and troubleshooting</h6>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    <div className="icon-box"><i className="fas fa-check-circle"></i></div>
                                                    <h6 className="title">Network performance audits and upgrades</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
