    ...
    return (
        <>
            ...
            <HeroPageTitle
                ...
                breadcrumb={[
                    { link: '/', title: 'Home' },
                    { link: '/data-analytics-classification', title: 'Data Analytics & Classification' },
                ]}
            />
                    ...
                    <div className="row">
                                    ...
                                    <div className="service-sidebar wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1200m">
                                        <div className="service-list">
                                            ...
                                            <li>
                                                ...
                                                <li>
                                                    <Link to="/data-analytics-classification" className="current">
                                                        <i className="fas fa-angle-right"></i>
                        ...
                        <div className="col-xl-8 col-lg-8">
                            <div className="services-details__content">
                                ...
                                <h2 className="mt-4">Turn Data into Action</h2>
                                <p>We help you uncover trends, patterns, and insights that drive smarter decision-making across all levels of your organization.</p>
                                
                                <div className="content mt-40">
                                    <div className="text">
                                        <h3>What Our Data Services Include</h3>
                                        <p>From collection to visualization, we turn raw data into a strategic asset for your business.</p>
                                    </div>
                                        ...
                                        <div className="row clearfix">
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    ...
                                                    <h6 className="title">Data cleansing, transformation, and warehousing</h6>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    <div className="icon-box"><i className="fas fa-check-circle"></i></div>
                                                    <h6 className="title">Custom dashboard and KPI tracking tools</h6>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    <div className="icon-box"><i className="fas fa-check-circle"></i></div>
                                                    <h6 className="title">AI-powered classification and forecasting</h6>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    <div className="icon-box"><i className="fas fa-check-circle"></i></div>
                                                    <h6 className="title">Industry-specific reporting models</h6>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    <div className="icon-box"><i className="fas fa-check-circle"></i></div>
                                                    <h6 className="title">Automated report generation</h6>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    <div className="icon-box"><i className="fas fa-check-circle"></i></div>
                                                    <h6 className="title">Integration with CRMs and ERPs</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
