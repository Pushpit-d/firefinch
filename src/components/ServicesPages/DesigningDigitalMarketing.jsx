...
function ServicesDetails() {
    ...
    return (
        <>
            <HomeOneHeader />
            <HeroPageTitle
                title="Designing & Digital Marketing"
                breadcrumb={[
                    { link: '/', title: 'Home' },
                    { link: '/designing-digital-marketing', title: 'Designing & Digital Marketing' },
                ]}
            />
                    ...
                    <div className="row">
                                    ...
                                    <div className="service-sidebar wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1200m">
                                        <div className="service-list">
                                            ...
                                            <li>
                                                ...
                                                <li>
                                                    <Link to="/designing-digital-marketing" className="current">
                                                        <i className="fas fa-angle-right"></i>
                        ...
                        <div className="col-xl-8 col-lg-8">
                            <div className="services-details__content">
                                ...
                                <h2 className="mt-4">Build Engagement That Lasts</h2>
                                <p>We design and develop modern social media platforms and tools that enhance digital presence and user connection.</p>
                                
                                <div className="content mt-40">
                                    <div className="text">
                                        <h3>How We Bring Your Social Platform to Life</h3>
                                        <p>Whether you are building a full-scale app or managing existing channels, we deliver on functionality, performance, and engagement.</p>
                                    </div>
                                        ...
                                        <div className="row clearfix">
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    ...
                                                    <h6 className="title">Custom social feed and user profile systems</h6>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    <div className="icon-box"><i className="fas fa-check-circle"></i></div>
                                                    <h6 className="title">Media upload, chat, and real-time features</h6>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    <div className="icon-box"><i className="fas fa-check-circle"></i></div>
                                                    <h6 className="title">Admin panels with content moderation tools</h6>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    <div className="icon-box"><i className="fas fa-check-circle"></i></div>
                                                    <h6 className="title">Social platform integration (Facebook, Instagram, etc.)</h6>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    <div className="icon-box"><i className="fas fa-check-circle"></i></div>
                                                    <h6 className="title">Scalable backend for user growth</h6>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-md-6 col-sm-12 column">
                                                <div className="single-item">
                                                    <div className="icon-box"><i className="fas fa-check-circle"></i></div>
                                                    <h6 className="title"> Analytics dashboard for content and user insights</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
