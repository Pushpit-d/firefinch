                    ...
                    <SwiperSlide className="slide-item">
                        ...
                        <div className="auto-container">
                            <div className="content-box">
                                <h1 className="title animate-1">Empowering<br />Modern Business</h1>
                                <div className="text animate-2">
                                From strategy to execution, we deliver powerful IT services that drive performance, efficiency, and digital transformation.
                                </div>
                    ...
                    {/* <SwiperSlide className="slide-item">
                        ...
                        <div className="auto-container">
                            <div className="content-box">
                                ...
                                <div className="text animate-2">
                                    There are many of passages of lorem Ipsum, but the majori have<br /> suffered alteration in some form.
                                </div>
                                <div className="btn-box animate-3">
                                    <Link to="/about-us" className="theme-btn btn-style-one hvr-light">
