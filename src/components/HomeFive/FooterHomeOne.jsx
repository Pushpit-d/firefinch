                            ...
                            <div className="footer-widget contact-widget">
                                ...
                                <div className="widget-content">
                                    ...
                                    <ul className="contact-info">
                                        ...
                                        <li><i className="fa fa-phone-square"></i> <Link to="tel:+926668880000">+92 666 888 0000</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div className="footer-bottom">
                <div className="auto-container">
                    <div className="inner-container">
                        <div className="copyright-text">&copy; Copyright reserved by <Link to="/">firefinchtechnologies.com</Link></div>
                    </div>
                </div>
            </div>
        </footer>
